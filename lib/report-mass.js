...
const recalculateMetrics = (lhr, jsonArr) => {
    ...
    const averageValues = generateValueFromCallback(arrValues, calculateAverage);
...
const makeReportMass = (reportArr) => {
    ...
    const generatedAverageJson = generateValueFromCallback(jsonValueArr, calculateAverage);
